...
type ServerConfig struct {
	Addr                        string        `help:"API server listen address" default:"127.0.0.1:3242" env:"VIIPER_API_ADDR"`
	...
	RequireLocalHostAuth        bool          `help:"Require authentication for clients connecting from localhost" default:"true" env:"VIIPER_API_REQUIRE_LOCALHOST_AUTH"`
	ConnectionTimeout           time.Duration `kong:"-"`
	PlatformOpts                `embed:""`
	// Password authenticates API clients and is always read from the credential file.
